...
function updateHeader(url) {
    ...
    switch (type[0]) {
        case 'voucher': {
            ...
            $('#headervoucher').addClass('active-filter');
            $('.voucherData').addClass('active-filter');
            break;
        }
        case 'busroute': {
            $('.active-filter').removeClass('active-filter');
        ...
        case 'timestart': {
            $('.active-filter').removeClass('active-filter');
            $('#headertimestart').addClass('active-filter');
            $('.timeStartData').addClass('active-filter');
            break;
        }
        case 'timeend': {
            $('.active-filter').removeClass('active-filter');
            $('#headertimeend').addClass('active-filter');
            $('.timeEndData').addClass('active-filter');

            break;
        }
        case 'discount': {
            $('.active-filter').removeClass('active-filter');
            $('#headerdiscount').addClass('active-filter');
            $('.discountData').addClass('active-filter');
            break;
        }
...
function getNewHref(pattern, url, hreff) {
    ...
    let uri = url.substr(url.search('voucherdata?') + 11);
    console.log(uri);
